...
void renderText() {
    // Guardar a proje??o anterior
    glMatrixMode(GL_PROJECTION);
    glPushMatrix();
    glLoadIdentity();
    // Projec??o ortogonal para que as coordenadas de desenho coincidam com o tamanho da janela em pixeis
    gluOrtho2D(0, w, h, 0);
    glMatrixMode(GL_MODELVIEW);
    glPushMatrix();
    glLoadIdentity();
    void* font = GLUT_BITMAP_HELVETICA_18;
    // Centrar o texto, calculando a dimens?o da mensagem em pixeis
